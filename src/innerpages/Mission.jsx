  ...
  return (
    <>
      <div className="bg-white shadow-lg rounded-lg p-8 mb-10">
        <h1 className="text-4xl font-bold text-left text-purple-600">
          Mission & Values
        </h1>
      </div>
      <div className="flex flex-wrap bg-gray-100">
        <div className="w-full lg:w-1/4 bg-purple-600 text-white p-8">
        ...
        <div className="w-full lg:w-3/4 bg-white p-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            ...
            With a team of skilled professionals, Morish Softech is committed to
            driving success and delivering exceptional value through our
            distinctive web solutions.
          </p>

          <h1 className="mt-10 text-3xl font-bold text-purple-600 mb-6">
            Our Values
          </h1>
          <p className="text-gray-600 leading-relaxed mb-8">

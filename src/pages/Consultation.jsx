...
const Consultation = () => {
  return (
    <div className="flex flex-wrap bg-white">
      <div className="p-6 text-white mb-10 mx-auto md:ml-16 lg:ml-32 xl:ml-[124px] bg-purple-500 md:w-1/3 lg:w-[30%]">
        ...
        <p className="text-xl md:text-2xl font-semibold mt-8">support@morishsoftech.in</p>
      </div>
